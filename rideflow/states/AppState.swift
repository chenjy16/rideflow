...
private extension AppState {
    ...
    func loadModelConfig(modelConfigURL: URL, modelLib: String, modelID: String, estimatedVRAMReq: Int, displayName: String?) -> ModelConfig? {
        do {
            ...
            modelConfig.displayName = displayName
            return modelConfig
        } catch {
    ...
    func downloadConfig(modelURL: URL?, modelLib: String, modelID: String, estimatedVRAMReq: Int, isBuiltin: Bool, displayName: String?) {
        ...
        let downloadTask = URLSession.shared.downloadTask(with: modelConfigURL) {
            ...
            do {
                guard let modelConfig = loadModelConfig(
                    ...
                    displayName: displayName  // 添加 displayName 参数
                ) else {
